...
export const fetchMessage = catchError(async (req: Request, res: Response, next: NextFunction) => {
  ...
  return next(new AppResponse(commonResponseMessages.FETCHED_SUCCESSFULLY, conversation));
});

export const sendMessage = catchError(async (req: Request, res: Response, next: NextFunction) => {
...
export const uploadFile = catchError((req: CustomRequest, res: Response, next: NextFunction) => {
...
export const downloadFile = catchError((req: CustomRequest, res: Response, next: NextFunction) => {
